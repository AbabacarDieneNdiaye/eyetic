...
@RestController
@RequestMapping("/api/eyetic-kafka")
public class EyeticKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EyeticKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EyeticKafkaResource(KafkaProperties kafkaProperties) {
